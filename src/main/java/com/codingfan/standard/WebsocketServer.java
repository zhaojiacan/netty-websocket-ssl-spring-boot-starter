        ...
        bootstrap.group(boss, worker)
                ...
                .childHandler(new ChannelInitializer<NioSocketChannel>() {
                    ...
                    protected void initChannel(NioSocketChannel ch) throws Exception {
                        ...
                        boolean sslEnable = config.isSslEnable();
                        //判断是否ssl
                        if(sslEnable){
                            String sslType = config.getSslType();
                            String sslKeyStorePath = config.getSslKeyStorePath();
                            String sslKeyStorePassword = config.getSslKeyStorePassword();
                            SSLContext sslContext = SslUtil.createSSLContext(sslType,sslKeyStorePath,sslKeyStorePassword);
